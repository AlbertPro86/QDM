...
function openOrdenModalMultiple(csIds) {
    ...
    iframe.src = 'orden_compra.php?cs_ids=' + csIds;
...
function openOrdenModal(csId) {
    const iframe = document.getElementById('ordenIframe');
    iframe.src = 'orden_compra.php?cs_id=' + csId;
    document.getElementById('ordenModal').classList.add('show');
...
async function sendOrdenByEmail() {
    ...
    const btn = document.querySelector('[onclick="sendOrdenByEmail()"]');
    const originalHTML = btn ? btn.innerHTML : '';
    if (btn) {
        btn.disabled = true;
        btn.style.opacity = '0.7';
        btn.innerHTML = `<svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" style="animation:spin 1s linear infinite"><path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg> Enviando...`;
    }
...
<div class="modal-overlay" id="ordenModal" style="z-index:1001">
    <div class="modal" style="max-width:900px;height:90vh;display:flex;flex-direction:column">
        ...
        <div style="flex:1;overflow:hidden;border-top:1.5px solid #e2e8f0">
            <iframe id="ordenIframe" style="width:100%;height:100%;border:none" src=""></iframe>
        </div>
        <div class="modal-footer" style="gap:8px;border-top:1.5px solid #e2e8f0">
