...
// Si no hay logo_url, buscar en configuraciones
if (!$logoUrl) {
    $logoUrl = getCfg($pdo, 'notif_logo_url', '');
}

// Generar HTML completo: mensaje + diseño cotización
$htmlFinal = generarEmailCotizacion($cot, $mensaje, $imagenPath ?: null, $logoUrl ?: null);
