    ...
    try{
        ...
        if(p.rut_url){
            ...
            rutHtml=`<div class="rut-banner">
                ...
                <a class="rut-btn outline" href="${esc(p.rut_url)}" target="_blank" rel="noopener">
            ...
            rutHtml=`<div class="rut-banner">
                <div class="rut-ico" style="background:#F0EDE6">
                    <svg width="16" height="16" fill="none" stroke="#8A867C" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                </div>
                <div class="rut-info">
                    <div class="rut-title">RUT</div>
                    <div class="rut-sub" style="color:#B8B3AB">Aún no hay RUT cargado — comunícate con QUANTUN Digital</div>
                </div>
            </div>`;
        }
